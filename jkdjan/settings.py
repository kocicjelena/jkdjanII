import os;
import os.path
# Django settings for jkdjan project.
...
SECRET_KEY = '1+++l^g7)e5&=ldi-&qfhdp2fz$fr04+x0s$=n_l33zvfsgq@t'
...
ROOT_URLCONF = 'jkdjan.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'jkdjan.wsgi.application'
